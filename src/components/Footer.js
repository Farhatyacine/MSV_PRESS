      ...
      <div className="container">
        <div className="row mb-5">
          <div className="col-md-4">
            ...
            <p>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi, accusantium optio unde
                ...
                <div className="post-entry-sidebar">
                  <ul>
                    <li>
                      <a href="">
                        <img
                          src={`${process.env.PUBLIC_URL}images/img_6.jpg`}
                          alt="2"
                          className="mr-4"
                        />
                        <div className="text">
                    ...
                    <li>
                      <a href="">
                        <img
                          src={`${process.env.PUBLIC_URL}images/img_3.jpg`}
                          alt="3"
                          className="mr-4"
                        />
                        <div className="text">
                    ...
                    <li>
                      <a href="">
                        <img
                          src={`${process.env.PUBLIC_URL}images/img_4.jpg`}
                          alt="4"
                          className="mr-4"
                        />
                        <div className="text">
