                  ...
                  <div className="col-md-7">
                    ...
                    <div className="post-entry-sidebar">
                      <ul>
                        <li>
                          <a href="">
                            <img src={`${process.env.PUBLIC_URL}images/img_6.jpg`} alt="2" className="mr-4"/>
                            <div className="text">
                        ...
                        <li>
                          <a href="">
                            <img src={`${process.env.PUBLIC_URL}images/img_3.jpg`} alt="3" className="mr-4"/>
                            <div className="text">
                              <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                              <div className="post-meta">
                                <span className="mr-2">March 15, 2018 </span> &bullet;
                        ...
                        <li>
                          <a href="">
                            <img src={`${process.env.PUBLIC_URL}images/img_4.jpg`} alt="4" className="mr-4"/>
                            <div className="text">
                              <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                              <div className="post-meta">
                                <span className="mr-2">March 15, 2018 </span> &bullet;
