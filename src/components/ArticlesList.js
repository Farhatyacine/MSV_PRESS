                ...
                <div className="col-md-12  main-content">
                    ...
                    <div className="col-md-12">
                        ...
                        <a href="blog-single.html">
                            <div className="image "   style={{backgroundImage: "url('images/img_10.jpg')"}}></div>
                            <span className="text">
                            <div className="post-meta">
                                <span className="category">Travel</span>
                                <span className="mr-2">March 15, 2018 </span> &bullet;
                        ...
                        <div className="post-entry-horzontal">
                        <a href="blog-single.html">
                            <div className="image "   style={{backgroundImage: "url('images/img_11.jpg')"}}></div>
                            <span className="text">
                            <div className="post-meta">
                                <span className="category">Lifestyle</span>
                                <span className="mr-2">March 15, 2018 </span> &bullet;
                        ...
                        <div className="post-entry-horzontal">
                        <a href="blog-single.html">
                            <div className="image "   style={{backgroundImage: "url('images/img_12.jpg')"}}></div>
                            <span className="text">
                            <div className="post-meta">
                                <span className="category">Food</span>
                                <span className="mr-2">March 15, 2018 </span> &bullet;
