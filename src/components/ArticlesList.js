      ...
      <div>
        <section className="site-section pt-5">
          <div className="container">
                  ...
                  <div>
                    ...
                    >
                      <div className="text half-to-full">
                        ...
                        <p>
                          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem nobis, ut
                          dicta eaque ipsa laudantium!
                        </p>
                      </div>
                    </a>
                  </div>
            ...
            <div className="row">{this.renderRecentArticles()}</div>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="row blog-entries">
              <div className="col-md-12  main-content">
                <div className="row">{this.renderArticlesList()}</div>
