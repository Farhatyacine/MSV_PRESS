          ...
          <div className="container">
            <div className="row">
              <div className="col-4 social">
                <a href="https://twitter.com/MonSuperVoisin" target={'_blank'}>
                  <span className="fa fa-twitter" />
                </a>
                <a href="https://www.facebook.com/monsupervoisin/" target={'_blank'}>
                  <span className="fa fa-facebook" />
                </a>
                <a href="https://www.monsupervoisin.fr/" target={'_blank'}>
                  <span className="fa fa-safari" target={'_blank'} />
                </a>
              </div>
              <div className="col-5" />
              <div className="col-3 social">
                <button className="btn btn-outline-light" onClick={() => this._signOut()}>
                  Sign out
                </button>
              </div>
            </div>
